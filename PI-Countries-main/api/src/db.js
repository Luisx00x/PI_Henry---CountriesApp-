...
const {
  DB_USER, DB_PASSWORD, DB_HOST, DB_DEPLOY_PASSWORD, DB_DEPLOY_HOST, DB_DEPLOY_PORT, DB_DEPLOY_NAME
} = process.env;

const PASSWORD = DB_DEPLOY_PASSWORD || DB_PASSWORD;
const HOST = DB_DEPLOY_HOST || DB_HOST;
const PORT = DB_DEPLOY_PORT || '';
const NAME = DB_DEPLOY_NAME || 'countries';

const sequelize = new Sequelize(`postgres://${DB_USER}:${PASSWORD}@${HOST}:${PORT}/${NAME}`, {
